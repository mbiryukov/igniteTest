...
public class Engine {
    ...
    public void setLocalListenerAnyKey(CacheUpdateListener cacheUpdateListener) {
        ...
        ignite.events(ignite.cluster().forCacheNodes("CACHE_NAME")).localListen(localListener, EVT_CACHE_OBJECT_PUT, EVT_CACHE_OBJECT_REMOVED);
    }
    ...
    public void setRemoteListenerAnyKey(CacheUpdateListener cacheUpdateListener) {
        ...
        ignite.events(ignite.cluster().forCacheNodes("CACHE_NAME")).remoteListenAsync(null, remoteListener, EVT_CACHE_OBJECT_PUT, EVT_CACHE_OBJECT_REMOVED);
    }
